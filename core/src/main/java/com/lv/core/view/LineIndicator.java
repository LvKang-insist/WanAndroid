...
public class LineIndicator extends View implements IPagerIndicator {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        PositionData next = FragmentContainerHelper.getImitativePositionData(mPositionDataList, position );
        ...
        mLineRect.left = leftX + (nextLeftX - leftX);
        mLineRect.right = rightX + (nextRightX - rightX);
